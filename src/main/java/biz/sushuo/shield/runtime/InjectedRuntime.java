...
public final class InjectedRuntime {
    ...
    public static Object _v(Object[] program, Object[] args) {
        boolean nativeRequired = embeddedNativeRequired() || Boolean.getBoolean("sushuo.vm.native.required");
        if (NATIVE_READY) {
            try {
    ...
    private static String nativeResourceName() {
        ...
        if (resource.startsWith("%%")) {
            return "/sushuo1337/sushuoprotect/lib/native/windows-x64/" + System.mapLibraryName("sushuo1337_vm") + ".dat";
        }
        return resource;
    }
